...
print("with a BETTER IY?!?!?!")
print("This won't be as good as IY, this just removes bloat ware and adds some custom features while implenting plugins!")
...
Credits.Text = "Syntaxical (made CMD-XYZ) & Edge"
...
CMDs[#CMDs + 1] = {NAME = 'fullclose / fullexit / rj / rejoin', DESC = 'yo: gurt'}
CMDs[#CMDs + 1] = {NAME = 'fakelag [true / false]', DESC = 'make your character feel laggy by me :3'}
CMDs[#CMDs + 1] = {NAME = 'touchinterests / touchinterest / firetouchinterests / firetouchinterst', DESC = 'self explaintory'}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (CLIENT)', DESC = 'activate your night vision goggles'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (CLIENT)', DESC = 'ya heard me'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://github.com/xxpwnxxx420lord/Cmd-XYZ/blob/main/init.lua?raw=true'))()")
	end
end)
...
addcmd("fullclose", {'fullexit', 'rj', 'rejoin'}, function(args, speaker)
    local tspmoiclfr = game:GetService("TeleportService")
    tspmoiclfr:Teleport(game.PlaceId, speaker)
end)
...
addcmd("ServerHopperGUI",{'SHG', "SH"}, function(args,speaker)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://github.com/xxpwnxxx420lord/Cmd-XYZ/blob/main/version?raw=true")
